...
inline std::vector<gui_string> ListFromString(const gui_string &args) {
...
class ILocalize {
public:
	virtual gui_string Text(const char *s, bool retainIfNotFound=true) = 0;
};
