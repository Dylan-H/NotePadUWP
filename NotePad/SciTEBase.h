...
inline int Minimum2(int a, int b) noexcept {
	return (a < b) ? a : b;
}

inline int Maximum2(int a, int b) noexcept {
	return (a > b) ? a : b;
}
...
protected:
	...
	virtual winrt::Windows::Foundation::IAsyncAction ReadEmbeddedProperties();
	void ReadEnvironment();
	winrt::Windows::Foundation::IAsyncAction ReadGlobalPropFile();
	...
	winrt::Windows::Foundation::IAsyncAction OpenCurrentFileAsync(long long fileSize, bool suppressMessage);
	...
	winrt::Windows::Foundation::IAsyncOperation<bool> OpenAsync(const FilePath &file, OpenFlags of = ofNone);
	...
	concurrency::task <FilePath>  GetDefaultPropertiesFileName();
