...
typedef void *FontID;
typedef winrt::Microsoft::Graphics::Canvas::CanvasDrawingSession SurfaceID; //void *SurfaceID;
typedef winrt::Microsoft::Graphics::Canvas::UI::Xaml::CanvasControl WindowID;//void *WindowID;
typedef void *MenuID;
